...
# ADD LINK32 NiInterface.lib mfcs42.lib ivi.lib instrsup.lib winmm.lib version.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"libc" /out:"Release\slg.m3.pc_viewer..exe"
...
# ADD LINK32 NiInterfaceD.lib mfcs42d.lib ivi.lib instrsup.lib winmm.lib version.lib /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"libc" /out:"Debug/slg.m3.pc_viewer.dbg..exe" /pdbtype:sept
...
# 	2:8:ImplFile:NiAll.cpp
# End Section
# Section slg2 : {083039C2-13F4-11D1-8B7E-0000F8754DA1}
...
# 	2:8:ImplFile:NiAll.cpp
# End Section
# Section slg2 : {F9043C85-F6F2-101A-A3C9-08002B2F49FB}
